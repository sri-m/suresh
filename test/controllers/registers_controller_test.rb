...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { cell: @register.cell, email: @register.email, name: @register.name, subject: @register.subject }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { cell: @register.cell, email: @register.email, name: @register.name, subject: @register.subject }
    assert_redirected_to register_path(assigns(:register))
  end
